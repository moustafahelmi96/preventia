    ...
    <Screen style={ROOT} preset="fixed">
      <MainContainer>
        <CurvedContainer>
          ...
          <Input title="Email" placeholder="********@test.com" keyboardType="email-address" onChangeText={(value) => {
            setValue("email", value)
          }} error={errors?.email?.message} />
          <Input title="Password" placeholder="********" secureTextEntry onChangeText={(value) => {
